...
const Recycler = require("./app/models/recycler"); // get the mongoose model
const otpDB = require("./app/models/otpdb"); // get the mongoose model
const Schedule = require("./app/models/schedule"); // get the mongoose model
const Pickup = require("./app/models/pickup"); // get the mongoose model
const Donation_list = require("./app/models/donation_list"); // get the mongoose model
